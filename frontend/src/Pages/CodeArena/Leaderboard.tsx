...
const Leaderboard = () => {
  ...
  const Avatar = ({
    ...
    const sizeClasses = {
      ...
      xl: 'w-20 h-20 md:w-24 md:h-24 text-2xl md:text-3xl',
    };

    return (
      <div
        className={`${sizeClasses[size]} ${bgColor} rounded-full flex items-center justify-center font-bold text-white overflow-hidden flex-shrink-0`}
      >
        {src ? (
          <img
            src={src}
            ...
            onError={(e) => {
              ...
              if (target.parentElement) {
                target.parentElement.innerHTML = name?.[0]?.toUpperCase() || '?';
              }
            }}
          />
        ) : (
            ...
            {rankings[1] && (
              ...
              >
                <div className="relative mb-3">
                  {/* ✅ FIXED: Use Avatar component */}
                  <Avatar
                    src={rankings[1]?.avatar}
                    name={rankings[1]?.odName}
                    size="lg"
                    bgColor="bg-gray-500"
                  />
                  <div className="absolute -top-1 -right-1 w-7 h-7 bg-gray-600 rounded-full flex items-center justify-center shadow-md border-2 border-white dark:border-gray-900">
              ...
              >
                <div className="relative mb-3">
                  ...
                  <Avatar
                    ...
                    name={rankings[0]?.odName}
                    size="xl"
                    bgColor="bg-amber-500"
                  />
                  <div className="absolute -top-2 -right-2 w-8 h-8 bg-amber-600 rounded-full flex items-center justify-center shadow-lg border-2 border-white dark:border-gray-900">
              ...
              >
                <div className="relative mb-3">
                  ...
                  <Avatar
                    ...
                    name={rankings[2]?.odName}
                    size="lg"
                    bgColor="bg-orange-500"
                  />
                  <div className="absolute -top-1 -right-1 w-7 h-7 bg-orange-600 rounded-full flex items-center justify-center shadow-md border-2 border-white dark:border-gray-900">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
              <div className="flex items-center gap-4">
                <div className="relative">
                  {/* ✅ FIXED: Use Avatar component for current user */}
                  <Avatar
                    src={user?.avatar || wallet?.avatar}
              ...
              {rankings.map((player, index) => (
                ...
                >
                  ...
                  <div className="col-span-5 flex items-center gap-3">
                    {/* ✅ FIXED: Use Avatar component in rankings list */}
                    <Avatar
                      src={player.avatar}
                      name={player.odName}
                      size="sm"
