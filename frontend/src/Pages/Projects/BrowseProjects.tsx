...
export default function BrowseProjects() {
  ...
  const { fetchAllIdeas, sendJoinRequest, fetchAllJoinRequests, getProjectMembers, fetchTasks: _fetchTasks, fetchCompletedTasksCount: _fetchCompletedTasksCount, fetchCompletedTasksData, deleteIdea, ideasRefreshSignal, triggerIdeasRefresh } = useDataContext();
