            ...
            <div className="grid md:grid-cols-4 gap-10">
              <div className="space-y-5">
                ...
                <div className="flex space-x-3 pt-2">
                  ...
                  <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" aria-label="SkillUpX on Twitter/X" className="w-9 h-9 bg-muted dark:bg-gray-800 hover:bg-blue-500 rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-blue-500/25">
                  ...
                  <a href="https://github.com" target="_blank" rel="noopener noreferrer" aria-label="SkillUpX on GitHub" className="w-9 h-9 bg-muted dark:bg-gray-800 hover:bg-gray-600 rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-gray-500/25">
                  ...
                  <a href="https://discord.com" target="_blank" rel="noopener noreferrer" aria-label="SkillUpX on Discord" className="w-9 h-9 bg-muted dark:bg-gray-800 hover:bg-indigo-600 rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-indigo-500/25">
