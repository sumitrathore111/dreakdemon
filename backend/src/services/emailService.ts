...
const emailTemplates = {
  ...
  newProject: (projectTitle: string, creatorName: string): EmailTemplate => ({
    ...
    html: getEmailWrapper(`
      ...
      <div style="text-align: center; margin-top: 30px;">
        <a href="${process.env.FRONTEND_URL || 'https://skillupx.vercel.app'}/projects" style="display: inline-block; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 15px 40px; text-decoration: none; border-radius: 30px; font-weight: bold; font-size: 16px; box-shadow: 0 4px 15px rgba(102, 126, 234, 0.4);">🔥 Explore & Join Now</a>
      </div>
    `, 'New Project Created')
  }),
  ...
  newIdea: (ideaTitle: string, submitterName: string, category: string): EmailTemplate => ({
    ...
    html: getEmailWrapper(`
      ...
      <div style="text-align: center; margin-top: 30px;">
        <a href="${process.env.FRONTEND_URL || 'https://skillupx.vercel.app'}/ideas" style="display: inline-block; background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); color: white; padding: 15px 40px; text-decoration: none; border-radius: 30px; font-weight: bold; font-size: 16px; box-shadow: 0 4px 15px rgba(240, 147, 251, 0.4);">💫 See This Amazing Idea</a>
      </div>
    `, 'New Idea Approved')
  }),
  ...
  newStudyGroup: (groupName: string, topic: string, creatorName: string): EmailTemplate => ({
    ...
    html: getEmailWrapper(`
      ...
      <a href="${process.env.FRONTEND_URL || 'https://skillupx.vercel.app'}/study-groups" style="display: inline-block; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 12px 30px; text-decoration: none; border-radius: 5px; margin-top: 20px;">Join Group</a>
    `, 'New Study Group')
  }),
  ...
  studyGroupJoinRequest: (groupName: string, requesterName: string): EmailTemplate => ({
    ...
    html: getEmailWrapper(`
      ...
      <a href="${process.env.FRONTEND_URL || 'https://skillupx.vercel.app'}/study-groups" style="display: inline-block; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 12px 30px; text-decoration: none; border-radius: 5px; margin-top: 20px;">Review Request</a>
    `, 'Join Request')
  }),
  ...
  studyGroupJoinApproved: (groupName: string): EmailTemplate => ({
    ...
    html: getEmailWrapper(`
      ...
      <a href="${process.env.FRONTEND_URL || 'https://skillupx.vercel.app'}/study-groups" style="display: inline-block; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 12px 30px; text-decoration: none; border-radius: 5px; margin-top: 20px;">Go to Group</a>
  ...
  newListing: (listingTitle: string, sellerName: string, price: number): EmailTemplate => ({
    ...
    html: getEmailWrapper(`
      ...
      <a href="${process.env.FRONTEND_URL || 'https://skillupx.vercel.app'}/marketplace" style="display: inline-block; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 12px 30px; text-decoration: none; border-radius: 5px; margin-top: 20px;">View Listing</a>
  ...
  newPurchase: (listingTitle: string, buyerName: string, price: number): EmailTemplate => ({
    ...
    html: getEmailWrapper(`
      ...
      <a href="${process.env.FRONTEND_URL || 'https://skillupx.vercel.app'}/marketplace/my-listings" style="display: inline-block; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 12px 30px; text-decoration: none; border-radius: 5px; margin-top: 20px;">View Sales</a>
    `, 'New Sale')
  }),
  ...
  purchaseConfirmation: (listingTitle: string, sellerName: string, price: number): EmailTemplate => ({
    ...
    html: getEmailWrapper(`
      ...
      <a href="${process.env.FRONTEND_URL || 'https://skillupx.vercel.app'}/marketplace/purchases" style="display: inline-block; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 12px 30px; text-decoration: none; border-radius: 5px; margin-top: 20px;">View Purchases</a>
    `, 'Purchase Confirmed')
  }),
  ...
  newReview: (listingTitle: string, reviewerName: string, rating: number): EmailTemplate => ({
    ...
    html: getEmailWrapper(`
      ...
      <a href="${process.env.FRONTEND_URL || 'https://skillupx.vercel.app'}/marketplace" style="display: inline-block; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 12px 30px; text-decoration: none; border-radius: 5px; margin-top: 20px;">View Review</a>
    `, 'New Review')
  }),
  ...
  battleWaiting: (challengerName: string, difficulty: string, prize: number): EmailTemplate => ({
    ...
    html: getEmailWrapper(`
      ...
      <div style="text-align: center; margin-top: 30px;">
        <a href="${process.env.FRONTEND_URL || 'https://skillupx.vercel.app'}/battles" style="display: inline-block; background: linear-gradient(135deg, #ff416c 0%, #ff4b2b 100%); color: white; padding: 15px 40px; text-decoration: none; border-radius: 30px; font-weight: bold; font-size: 16px; box-shadow: 0 4px 15px rgba(255, 65, 108, 0.4);">⚔️ Join Battle Now!</a>
      </div>
    `, 'Battle Waiting')
  }),
  ...
  battleInvite: (challengerName: string, difficulty: string, prize: number): EmailTemplate => ({
    ...
    html: getEmailWrapper(`
      ...
      <a href="${process.env.FRONTEND_URL || 'https://skillupx.vercel.app'}/battles" style="display: inline-block; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 12px 30px; text-decoration: none; border-radius: 5px; margin-top: 20px;">Accept Challenge</a>
    `, 'Battle Challenge')
  }),
  ...
  battleResult: (opponentName: string, result: 'won' | 'lost', prize: number): EmailTemplate => ({
    ...
    html: getEmailWrapper(`
      ...
      <a href="${process.env.FRONTEND_URL || 'https://skillupx.vercel.app'}/battles" style="display: inline-block; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 12px 30px; text-decoration: none; border-radius: 5px; margin-top: 20px;">View Battles</a>
    `, 'Battle Result')
  }),
  ...
  newChallenge: (challengeTitle: string, difficulty: string, points: number): EmailTemplate => ({
    ...
    html: getEmailWrapper(`
      ...
      <a href="${process.env.FRONTEND_URL || 'https://skillupx.vercel.app'}/challenges" style="display: inline-block; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 12px 30px; text-decoration: none; border-radius: 5px; margin-top: 20px;">Solve Challenge</a>
    `, 'New Challenge')
  }),
  ...
  newJoinRequest: (projectTitle: string, requesterName: string): EmailTemplate => ({
    ...
    html: getEmailWrapper(`
      ...
      <a href="${process.env.FRONTEND_URL || 'https://skillupx.vercel.app'}/projects" style="display: inline-block; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 12px 30px; text-decoration: none; border-radius: 5px; margin-top: 20px;">Review Request</a>
    `, 'Join Request')
  }),
  ...
  joinRequestApproved: (projectTitle: string): EmailTemplate => ({
    ...
    html: getEmailWrapper(`
      ...
      <a href="${process.env.FRONTEND_URL || 'https://skillupx.vercel.app'}/projects" style="display: inline-block; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 12px 30px; text-decoration: none; border-radius: 5px; margin-top: 20px;">Go to Project</a>
    `, 'Join Request Approved')
  }),
  ...
  joinRequestRejected: (projectTitle: string): EmailTemplate => ({
    ...
    html: getEmailWrapper(`
      ...
      <a href="${process.env.FRONTEND_URL || 'https://skillupx.vercel.app'}/projects" style="display: inline-block; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 12px 30px; text-decoration: none; border-radius: 5px; margin-top: 20px;">Browse Projects</a>
  ...
  newHelpRequest: (title: string, category: string, requesterName: string): EmailTemplate => ({
    ...
    html: getEmailWrapper(`
      ...
      <a href="${process.env.FRONTEND_URL || 'https://skillupx.vercel.app'}/help" style="display: inline-block; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 12px 30px; text-decoration: none; border-radius: 5px; margin-top: 20px;">Help Out</a>
    `, 'New Help Request')
  }),
