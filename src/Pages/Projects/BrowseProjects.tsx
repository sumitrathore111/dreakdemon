...
import { useDataContext } from '../../Context/UserDataContext';
  ...
  const handleDownloadCertificate = () => {
    ...
    doc.setFontSize(24);
    doc.setTextColor('#fff');
    doc.text(Users.displayName || Users.email || 'User', 148, 90, { align: 'center' });
    doc.setFontSize(18);
    doc.setTextColor('#fff');
    doc.text(`has successfully completed ${TASKS_REQUIRED} verified tasks`, 148, 110, { align: 'center' });
    doc.setFontSize(16);
    doc.setTextColor('#fff');
    doc.text('on the NextStep platform.', 148, 125, { align: 'center' });
    doc.setFontSize(14);
    doc.setTextColor('#fff');
    doc.text(`Date: ${new Date().toLocaleDateString()}`, 148, 145, { align: 'center' });
    doc.setFontSize(12);
    doc.setTextColor('#fff');
    doc.text('Certificate ID: NEXTSTEP-' + user.uid, 148, 160, { align: 'center' });
    doc.setFontSize(10);
    doc.setTextColor('#fff');
    doc.text('This certificate is generated by NextStep and is valid for all official purposes.', 148, 175, { align: 'center' });
            ...
            <div className="flex flex-col md:flex-row gap-6">
              ...
              <div className="flex-1">
                <div className="bg-white rounded-2xl shadow-lg p-6">
                  ...
                  <p className="text-gray-600 mb-4">Showcasing your verified achievements across projects</p>
                  {completedTasks.length === 0 ? (
                    <div className="text-center py-12">
                        ...
                        <div key={projectTitle} className="bg-gradient-to-br from-white to-blue-50 rounded-2xl shadow-lg hover:shadow-xl transition-all p-6 border border-cyan-100">
                          ...
                          <div className="divide-y divide-cyan-100">
                            {completedByProject[projectTitle].map((t: any, idx: number) => {
                              ...
                              return (
                                <div key={t.id} className="flex flex-col sm:flex-row items-center sm:items-stretch justify-between py-3 px-2 sm:px-4 hover:bg-cyan-50 rounded-lg transition-all">
                                  <div className="flex items-center gap-3 flex-1 min-w-0">
                                    <span className="text-green-600 font-bold text-lg w-8 text-center">{idx + 1}.</span>
                                    <span className="font-semibold text-gray-900 text-base break-words whitespace-normal flex-1">{t.title || t.name || 'Task'}</span>
                                  </div>
                      ...
                      <div>
                        <div className="mb-3">
                          <div className="flex items-center justify-between mb-2">
                            <span className="text-gray-700 font-semibold">{completedCount} of {TASKS_REQUIRED} tasks completed</span>
