...
export default function BrowseProjects() {
  ...
  const { fetchAllIdeas, sendJoinRequest, fetchAllJoinRequests, getProjectMembers, fetchTasks, fetchCompletedTasksCount, fetchCompletedTasksData, deleteProject, ideasRefreshSignal, triggerIdeasRefresh } = useDataContext();
