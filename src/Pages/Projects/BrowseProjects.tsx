...
export default function BrowseProjects() {
  ...
  const { fetchAllIdeas, sendJoinRequest, fetchAllJoinRequests, getProjectMembers, fetchTasks: _fetchTasks, fetchCompletedTasksCount: _fetchCompletedTasksCount, fetchCompletedTasksData, deleteProject, ideasRefreshSignal, triggerIdeasRefresh } = useDataContext();
  ...
  const loadUserAccessStatus = async () => {
    ...
    try {
      ...
      userRequests.forEach((req: any) => {
        ...
        const ideaId = projectToIdeaMap[req.projectId] || req.projectId;
      ...
      for (const project of approvedProjects) {
        ...
        if (isMember) {
          // Store the idea ID in memberships (since UI uses idea IDs)
