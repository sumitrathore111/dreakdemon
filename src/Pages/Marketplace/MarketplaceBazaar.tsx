          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
            ...
            <div className="flex flex-wrap gap-3">
              <Link
                ...
                className="px-4 py-2 bg-white border-2 border-teal-500 text-teal-500 rounded-lg hover:bg-teal-50 transition-colors flex items-center gap-2 font-semibold"
              >
              ...
              <Link
                ...
                className="px-4 py-2 bg-white border-2 border-teal-500 text-teal-600 rounded-lg hover:bg-teal-50 transition-colors flex items-center gap-2 font-semibold"
              >
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg bg-gray-50 text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-teal-400 focus:bg-white transition-all"
              />
            </div>
            ...
            <select
              ...
              className="px-4 py-3 border border-gray-300 rounded-lg bg-gray-50 text-gray-900 focus:outline-none focus:ring-2 focus:ring-teal-400 font-medium cursor-pointer"
            >
