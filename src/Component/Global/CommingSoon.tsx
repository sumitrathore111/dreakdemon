...
export default function ComingSoon() {
  return (
    <div className="relative flex items-center justify-center min-h-screen bg-gradient-to-br from-white to-gray-50 px-6">
      {/* Futuristic blurred shapes */}
      <div className="absolute top-10 left-10 w-40 h-40 bg-[#00ADB5] opacity-20 rounded-full blur-3xl"></div>
      <div className="absolute bottom-20 right-10 w-52 h-52 bg-black opacity-10 rounded-full blur-3xl"></div>
      ...
      <div className="relative text-center max-w-xl">
        ...
        <div className="mt-8 flex justify-center space-x-6">
          <a href="#" className="text-gray-500 hover:text-[#00ADB5] transition-colors">
